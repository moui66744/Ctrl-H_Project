...
public class StmtVisitorTest {
    ...
    public static void main(String[] args) throws IOException {
        ...
        s2 = stmtVisitor.ifStmtFilter(s2, c2, StmtVisitor.IF_TYPE.WITHOUT_ELSE);
        output(s2);
...
//        output(s7);
        ...
        s8 = stmtVisitor.tryStmtFilter(s8, null, StmtVisitor.TRY_TYPE.WITHOUT_CATCH_WITH_FINALLY);
        output(s8);
